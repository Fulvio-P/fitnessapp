<template>
  <div id="box" v-bind:class="classBindings" class="sidebar-margin">
    <p>{{ msgobj.message }}</p>
    <b-button @click="hide" class="float-right">
      Chiudi
    </b-button>
  </div>
</template>
...
#box:not(.col-succ):not(.col-err) {
  /*include il type "info" e tutti gli altri type, nel malaugurato caso in cui ce ne arrivi uno anomalo*/
